...
function Book() {
    return (
        ...
        <div className="text-container"> 
            ...
            <br /><br />
            And if that wasn't enough, a few years ago, he created his own website to promote Mexican artists (you must visit <a href="https://www.pintoresmexicanos.com/" target="_blank" rel="noreferrer" >www.pintoresmexicanos.com</a> to see what I'm talking about ... It's a beauty!)
            <br /><br />
